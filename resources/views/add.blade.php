...
<div class="section">
  ...
  {!! csrf_field() !!}
    <div class="row">
      ...
      <div class="row">
        <div class="input-field col s12">
          <textarea id="textarea2" class="materialize-textarea" name="komentar"></textarea>
          <label for="textarea2">Komentar</label>
        </div>
      </div>
      <div class="row">
          <div class="input-field col s12">
            <input type="text" class="validate" name="rating">
            <label for="title">Sentimen</label>
          </div>
    </div>
    <div class="row">
      <img src="http://placehold.it/100x100" id="preview" style="max-width:200px;max-height:200px;float:left;" />
    </div>
    <div class="row">
